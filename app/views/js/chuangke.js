...
function secondShow(this_id) {
    if (this_id == "01") {
       ...
       "<p>【青年创】目前属于启动阶段，现针对全国范围高校招募创客，限额200名，在经过项目筛选后及团队面试后，平台将以直接支助创业资金，不参与分红的形式与创业者进行合作，项目报名时间截止日为2015-12-31日!只要你是在校大学生，并且有创业的梦想与激情，快来我们一起创业！ </p>");
    }
    else if (this_id == "03") {
        $("#secondFont").css("background", "#070815");
        $("#secondFont").css("color", "gray");
